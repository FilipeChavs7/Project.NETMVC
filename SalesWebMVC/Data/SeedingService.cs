...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Zeca Pagods", "zeca@gmail.com", new DateTime(1994, 2, 17), 10000, d2);
            Seller s3 = new Seller(3, "Pereira FIlho", "pereira@gmail.com", new DateTime(1999, 3, 31), 2100, d3);
            Seller s4 = new Seller(4, "Hannah Montana", "hannah@gmail.com", new DateTime(2001, 1, 01), 4300, d4);
            Seller s5 = new Seller(5, "Lazaro Ramos", "ramos@gmail.com", new DateTime(1990, 2, 14), 44442, d2);
            Seller s6 = new Seller(6, "Jennifer Lopes", "jennifer@gmail.com", new DateTime(1985, 9, 24), 12300, d4);
